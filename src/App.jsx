...
export default function Portfolio() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-white p-8 flex flex-col justify-center items-center font-[Poppins]">
      <h1 className="text-6xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-500 drop-shadow-lg">Shivam Mishra</h1>
      <p className="text-2xl mb-6 text-pink-300 font-medium tracking-wide">MERN Stack Developer</p>
      ...
      <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-6 mb-8 w-full max-w-xl shadow-2xl border border-white/20">
        <h2 className="text-3xl font-semibold mb-4 text-center text-cyan-300">Skills</h2>
      ...
      <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl px-6 py-6 mb-8 shadow-xl w-full max-w-xl text-center border border-yellow-300/20">
        <h3 className="text-3xl font-bold text-yellow-300 mb-2">LeetCode Profile</h3>
        <p className="text-white text-lg mb-4">Check out my problem-solving journey on LeetCode.</p>
        <a
